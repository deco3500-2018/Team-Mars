...
public class ExampleSpeechToText : MonoBehaviour
{
    ...
    [SerializeField]
	private string _serviceUrl = "https://gateway-syd.watsonplatform.net/speech-to-text/api";
    ...
    [SerializeField]
	private string _iamApikey = "u1YdVUt4FiNZRx4AyU9sZJmjZz7tGZac0bOggX0hJU9Q";
